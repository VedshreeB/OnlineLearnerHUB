    ...
    return async (dispatch) => {
        try {
            ...
            const { data } = await axios({
                method: "Post",
                url: "https://onlinelearnerhub.herokuapp.com/api/user/register",
...
export const userLogin = (userLoginCredentials,history) => {
    return async (dispatch) => {
        try {
            ...
            const { data } = await axios({
                method: "Post",
                url: "https://onlinelearnerhub.herokuapp.com/api/user/login",
...
export const getOTP = (userEmail) => {
    return async (dispatch) => {
        try {
            await axios({
                method: 'Post',
                url: 'https://onlinelearnerhub.herokuapp.com/api/user/forgotPassword',
                data: userEmail
            })
...
export const submitOTP = (newPasswordWithOtp, history) => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Post',
                url: "https://onlinelearnerhub.herokuapp.com/api/user/postOTP",
...
export const updatePassword = (passwordData,history) => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Post',
                url: "https://onlinelearnerhub.herokuapp.com/api/user/updatePassword",
                data: passwordData
            })
...
export const addCourse = (courseCredentials,history) => {
    return async (dispatch) => {
        try {
            ...
            const { data } = await axios({
                method: "Post",
                url: "https://onlinelearnerhub.herokuapp.com/api/user/addCourse",
...
export const addToCart = (courseId) => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: "Get",
                url: `https://onlinelearnerhub.herokuapp.com/api/user/addToCart/${courseId}`,
            })
...
export const buyCourse = (courseId,history) => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: "Get",
                url: `https://onlinelearnerhub.herokuapp.com/api/user/buyCourse/${courseId}`,
            })
            dispatch(userLoginHelper(data.message))
...
export const myCourses = () => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: "Get",
                url: `https://onlinelearnerhub.herokuapp.com/api/user/userCourses`,
            })
            const { message } = data
...
export const courseDetailsById = (courseId) => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: "Get",
                url: `https://onlinelearnerhub.herokuapp.com/api/user/getCourseById/${courseId}`,
            })
            const { message } = data
            dispatch({
...
export const askQuestion = (courseId,question) => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: "Post",
                url: `https://onlinelearnerhub.herokuapp.com/api/user/commentOnCourse/${courseId}`,
                data:{question}
            })
            const { message } = data
            dispatch({
